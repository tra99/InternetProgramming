...
function hr(e, t, n = !1) {
  ...
  return !r && !l
    ...
    : (B(r) ? r.forEach((c) => (i[c] = null)) : de(i, r),
      ie(e) && s.set(e, i),
      i);
}
function Tn(e, t) {
...
function yr(e, t, n = fe) {
  ...
  if ((kn(t, s, n), n)) {
    let o = n.parent;
    for (; o && o.parent; )
      br(o.parent.vnode) && sl(s, t, n, o), (o = o.parent);
  }
}
function sl(e, t, n, s) {
  const o = kn(t, e, s, !0);
  ...
  gf = Ru({
    ...
    routes: [
      { path: "/", name: "home", component: pf },
      {
        ...
        name: "category",
        component: () => Lo(() => import("./CategoryPage-7de67bd8.js"), []),
      },
      {
        ...
        component: () =>
          Lo(
            () => import("./ProductDetailPage-5f5c90ac.js"),
            [
              "assets/ProductDetailPage-5f5c90ac.js",
